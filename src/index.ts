...
const trace = (...args: any[]) => {
  ...
  try {
    ...
    if (!filters || (filters && filters.length === 0) || (filters && filters.length === 0) || (filters && filters.find(filter => message.includes(filter)))) {
...
const debug = (...args: any[]) => {
  ...
  try {
    ...
    if (!filters || (filters && filters.length === 0) || (filters && filters.find(filter => message.includes(filter)))) {
